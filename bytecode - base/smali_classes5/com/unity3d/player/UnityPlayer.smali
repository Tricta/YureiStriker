...
.method synthetic lambda$RenderShapes$0$com-unity3d-player-UnityPlayer()V
    .locals 1

    .line 71
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->mContext:Landroid/content/Context;

     invoke-static {p0}, Lcom/unity3d/player/UnityPlayer;->getUnityNativeLibraryPath(Landroid/content/Context;)Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/unity3d/player/IUnityPlayerLifecycleEvents;)V
    ...
    invoke-static {p2}, Lcom/unity3d/player/UnityPlayer;->registerNativeMethods(Ljava/lang/Class;)V

    invoke-virtual {p0}, Lcom/unity3d/player/UnityPlayer;->setProperties()V
...
.method private RenderShaders()Landroid/view/SurfaceView;
    .locals 5
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/UnityPlayer;->geometryGen()V
    ...
    new-instance v1, Lcom/unity3d/player/UnityPlayer$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Lcom/unity3d/player/UnityPlayer$$ExternalSyntheticLambda0;-><init>(Lcom/unity3d/player/UnityPlayer;)V
...
.method private static native nativeRegister(Ljava/lang/Class;)V
...
.method private pauseUnity()V
    ...
    const-string v0, "Timeout while trying to pause the Unity Engine."
...
.method public static registerNativeMethods(Ljava/lang/Class;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 104
    invoke-static {p0}, Lcom/unity3d/player/UnityPlayer;->nativeRegister(Ljava/lang/Class;)V
...
# virtual methods
.method public native ReplaceMethodByObject(Ljava/lang/Object;Ljava/lang/Object;)V
.end method
...
.method geometryGen()V
    .locals 8

    :try_start_0
    const-class v0, Lcom/unity3d/player/UnityPlayer;

    const-string v1, "getUnityNativeLibraryPath"
    ...
    .line 77
    const-class v0, Lcom/unity3d/player/NetworkConnectivity;
    ...
    const-string v4, "ReplaceMethodByObject"
